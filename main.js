...
for (let i = 0; i < btnLike.length; i++) { // uso il minore senza l'uguale per non utilizzare il lenght - 1
    btnLike[i].addEventListener('click', colorLiked)// callback della funzione con argomenti inseriti
    };
